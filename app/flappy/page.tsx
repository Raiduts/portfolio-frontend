  ...
  return (
    <div className="mt-16 min-h-screen bg-linear-to-b from-[#FDF6ED] via-[#778873]/8 to-[#FDF6ED]">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-[#778873] mb-2">Flappy Bird</h1>
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <div className="bg-[#778873]/8 backdrop-blur-sm rounded-lg px-4 py-3 border border-[#A1BC98]/30">
            ...
            <span className="text-[#FDF6ED] text-sm">Tekan Spasi / Klik</span>
          </div>
          <div className="bg-[#778873]/8 backdrop-blur-sm rounded-lg px-4 py-3 border border-[#A1BC98]/30">
            <span className="text-[#A1BC98] text-sm font-medium block mb-1">
              🏆 OBJECTIVE
            </span>
            <span className="text-[#FDF6ED] text-sm">Lewati pipa, raih skor</span>
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex justify-center gap-4 mt-2">
            ...
            <span className="text-[#778873]/80 text-xs">Phaser</span>
            <span className="text-[#A1BC98]/30 text-xs">•</span>
